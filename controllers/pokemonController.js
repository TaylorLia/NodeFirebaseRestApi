...
pokemonController.prototype.post = async (req,res) => {
  ...
  // retornando uma resposta para a requisiçõ
  res.status(201).send(resultado)
}

pokemonController.prototype.put = async (req,res) => {
  // enviando um objeto para receber a execução do repositório
...
pokemonController.prototype.getById = async(req,res) =>{
  // criando um ojeto para receber a execução do repositório
  let pokemon = await new repository().getById(req.params.id)
  // retornando uma resposta para a requisição
...
//   try {
//     // criando um objeto para receber a coleção 'pokemons'
...
//     // criando um array vazio que irá receber os Pokemones
//     const pokemonsArray = []
...
//       res
//         .status(404)
//         .send('Não foi encontrado um Pokemon com o ID informado!')
//     } else {
